    ...
    return (
            <>
               ...
               <div className="relative max-w-7xl mx-auto h-full flex items-center justify-start px-6">
                    ...
                    <div class="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-8 w-full max-w-lg">
                    
                    
                    <h1 class="text-3xl md:text-4xl font-serif text-gray-900 leading-snug">
                    ...
                    <div class="mt-6 flex flex-col md:flex-row gap-3">
                        ...
                        <button class="bg-[#6b1d3a] hover:bg-[#5a1830] text-white px-6 py-2 rounded-md text-sm font-medium transition">
                        Shop now
                        </button>
